...
// HasWasherProfile applies the HasEdge predicate on the "washer_profile" edge.
func HasWasherProfile() predicate.User {
...
// HasWasherProfileWith applies the HasEdge predicate on the "washer_profile" edge with a given conditions (other predicates).
func HasWasherProfileWith(preds ...predicate.WasherProfile) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newWasherProfileStep()
